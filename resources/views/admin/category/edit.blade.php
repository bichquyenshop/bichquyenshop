...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form role="form" method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{ route('edit_menu', $menu->id) }}">
                    @csrf
                        ...
                        <div class="box-body">
                            <div class="col-md-5">
                                <div class="form-group {!! $errors->first('name','has-error') !!}">
                                    ...
                                    <div class="col-sm-6">
                                        <input required maxlength="50" type="text" id="title" class="form-control" name="name" value="{{!empty(old('name')) ? old('name') : $menu->name}}" placeholder="Tên">
